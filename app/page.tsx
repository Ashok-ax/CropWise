...
const features = [
  { icon: LandPlot, title: 'My Farm Profile', desc: 'A digital twin of your farm — land, soil, water, crops, animals, all in one place.' },
  { icon: Brain, title: 'Crop Recommendations', desc: 'Transparent rule-based recommendations matching your soil, water, season and budget.' },
  { icon: Calculator, title: 'Farm Simulator', desc: 'Compare farming options and run What-If scenarios before you invest a rupee.' },
  { icon: CloudSun, title: 'Weather Intelligence', desc: 'Current weather, 7-day forecast, and farming-specific advice — not just "rain tomorrow".' },
  { icon: Wallet, title: 'Finance Tracking', desc: 'Track expenses, revenue, and profit/loss per crop or activity with clear charts.' },
  { icon: Bell, title: "Today's Farm", desc: 'A daily action center combining weather, crop stage, reminders and deadlines.' },
  { icon: Brain, title: 'CropWise AI', desc: 'Ask questions in plain language. The assistant uses your farm profile as context.' },
  { icon: ShieldCheck, title: 'Government Schemes', desc: 'Real schemes with eligibility, documents, and official sources — verified dates shown.' },
];
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="animate-slide-up">
              ...
              <p className="mt-6 max-w-xl text-lg text-muted-foreground text-balance">
                CropWise brings farming knowledge, weather intelligence, financial planning,
                government schemes, and AI-powered assistance into one simple platform.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground text-balance">
              CropWise is an intelligent digital farming platform that supports crop, vegetable,
              fruit, dairy, poultry, livestock, shepherding and fisheries farmers — all in one
              ecosystem. We do not just give farmers information. We help them make better decisions.
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-foreground sm:text-4xl">How CropWise Works</h2>
            <p className="mt-4 text-muted-foreground">From sign-up to smarter decisions in four simple steps.</p>
          </div>
      ...
      <section id="features" className="border-y border-border bg-muted/20 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Core Features</h2>
            <p className="mt-4 text-muted-foreground">Everything a farmer needs, in one place.</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <Card className="overflow-hidden border-primary/30 bg-gradient-to-br from-primary/10 via-accent/5 to-background">
            <CardContent className="p-10 text-center md:p-16">
              <h2 className="font-display text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                Start your farm journey today
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-muted-foreground text-balance">
                Join CropWise and turn your farm data into smarter decisions. Free to start,
                works on any device.
              </p>
