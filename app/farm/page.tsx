...
// Leaflet touches the browser `window` object, so it can't render on the server —
// load it client-side only.
const LocationPicker = dynamic(
  () => import('@/components/app/location-picker').then((m) => m.LocationPicker),
    ...
    <div className="mx-auto max-w-4xl">
      ...
      {editing ? (
        <SectionCard title="Edit farm details">
          ...
          <Disclaimer>Setting your farm location improves weather accuracy and helps identify location-specific government schemes.</Disclaimer>
        </SectionCard>
      ) : (
